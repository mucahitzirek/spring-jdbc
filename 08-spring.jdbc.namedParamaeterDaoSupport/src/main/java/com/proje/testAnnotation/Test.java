...
public class Test {
	...
	public static void main(String[] args) {
		...
		PersonelRepository personelRepository = applicationContext.getBean("personelRepository",
				PersonelRepositoryImpl.class);

		Personel personel = new Personel(103, "MYZ", "ZYM", createCustomDate(12, 12, 1111), "12121221");
